...
$require = array('お名前','Email','お問い合わせの種類','お問い合わせ内容');
...
<script>
  ...
  <title>確認画面｜松葉屋茶寮・方舟GALLERY</title>
  ...
  <meta name="description" content="松葉屋茶寮・方舟GALLERYへのお問い合わせページ。ご予約・商品に関するご質問や、取材・イベントに関するご相談など、お気軽にご連絡ください。">
  <meta property="og:title" content="松葉屋茶寮">
  <meta property="og:description" content="松葉屋茶寮・方舟GALLERYへのお問い合わせページ。ご予約・商品に関するご質問や、取材・イベントに関するご相談など、お気軽にご連絡ください。">
          ...
          <div class="contact-wrapper"> 
            <div class="inner-wrapper">
              ...
              <div class="horizontal-title-wrapper">
                <!--<h2 class="jp">お問い合わせ</h2><span class="border"></span>-->
...
<script>
  ...
  <title>お問い合わせありがとうございました｜松葉屋茶寮・方舟GALLERY</title>
  <meta name="description" content="松葉屋茶寮・方舟GALLERYへのお問い合わせページ。ご予約・商品に関するご質問や、取材・イベントに関するご相談など、お気軽にご連絡ください。">
  <meta property="og:title" content="松葉屋茶寮">
  <meta property="og:description" content="松葉屋茶寮・方舟GALLERYへのお問い合わせページ。ご予約・商品に関するご質問や、取材・イベントに関するご相談など、お気軽にご連絡ください。">
  <meta property="og:image" content="https://mtbysr.jp/assets/images/ogp.png" />
