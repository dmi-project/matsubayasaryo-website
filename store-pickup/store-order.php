...
$site_top = "https://mtbysr.jp/";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "storepickup@mtbysr.jp";
...
$Referer_check_domain = "mtbysr.jp";
...
$require = array('お名前','お名前（カナ）','電話番号','Email','領収書の有無','受け取り希望時間帯','受け取り希望日');
...
$re_subject = "ご予約・お取り置きのお申し込みを承りました";
...
このたびは、OKASHIYA商品のご予約・お取り置きのお申し込みをいただき、誠にありがとうございます。
以下の内容で承りました。

当メールは注文確定のものではございません。
担当者が内容を確認し、追ってご連絡をさせていただきます。
...
＜キャンセルについて＞
受け取り予定時間に合わせて、出来立てのお菓子をご用意しております。
やむを得ない事情以外でのキャンセルはお控えいただきますよう、お願い申し上げます。

1万円未満のご注文：
・1営業日前：商品代金の30%
・当日キャンセル・無断キャンセル：商品代金の100%

1万円以上のご注文：
・1営業日前：商品代金の80%
・当日キャンセル・無断キャンセル：商品代金の100%

なお、営業時間は平日10時〜20時です。時間外のお問い合わせに関しては、翌営業日にご連絡差し上げます。
何かご不明点がございましたら、以下の連絡先までお問い合わせください。
...
//----------------------------------------------------------------------
//  受け取り希望日チェック（当日・過去・休業日の拒否）
//  ※クライアント側(JavaScript)は無効化・改変で回避できるため、サーバー側でも必ず検証する
//  ※タイムゾーンは冒頭(date_default_timezone_set('Asia/Tokyo'))で設定済み
//----------------------------------------------------------------------
if(empty($errm) && !empty($_POST['受け取り希望日'])){
	$pickupRaw = trim($_POST['受け取り希望日']);

	// 受け取り不可日のリスト（index.html の unavailableDates と必ず一致させること）
	$unavailableDates = array(
		'2025-12-29','2025-12-30','2025-12-31',
		'2026-01-01','2026-01-02','2026-01-03',
	);

	if(!preg_match('/\A\d{4}-\d{2}-\d{2}\z/', $pickupRaw)){
		$errm .= "<p class=\"error_messe\">【受け取り希望日】の形式が正しくありません。</p>\n";
		$empty_flag = 1;
	}else{
		$today_ymd = date('Y-m-d'); // 本日（日本時間）
		// YYYY-MM-DD形式の文字列は辞書順比較＝日付の前後比較になる
		if($pickupRaw <= $today_ymd){
			$errm .= "<p class=\"error_messe\">【受け取り希望日】当日および過去の日付では受け取りを承っておりません。翌日以降の日付をご指定ください。</p>\n";
			$empty_flag = 1;
		}elseif(in_array($pickupRaw, $unavailableDates, true)){
			$errm .= "<p class=\"error_messe\">【受け取り希望日】ご指定の日は休業日のため、店舗での受け取りを承っておりません。別の日をご指定ください。</p>\n";
			$empty_flag = 1;
		}
	}
}
...
<script>
  ...
  gtag('config', 'G-CMXCC5GNLQ');
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="https://mtbysr.jp/assets/images/apple-touch-icon-320x320.png">
    <link rel="icon" type="image/png" href="https://mtbysr.jp/assets/images/favicon/favicon.ico">
    <link rel="manifest" href="https://mtbysr.jp/assets/images/favicon/safari-pinned-tab.png">
    <link rel="mask-icon" href="https://mtbysr.jp/assets/images/favicon/safari-pinned-tab.png" color="#000000">
    <meta name="msapplication-TileColor" content="#000000">
    <meta name="theme-color" content="#000000">
    <link rel="stylesheet" href="css/store-pickup.css">
    <script src="https://unpkg.com/imagesloaded%405.0.0/imagesloaded.pkgd.min.js"></script>
    
    
    
  <title>ご予約・お取り置き｜松葉屋茶寮・方舟GALLERY</title>
  ...
  <meta name="description" content="松葉屋茶寮のお菓子やロールケーキのご予約・お取り置きはこちらから。店舗受け取りのご案内や注意事項もご確認いただけます。">
  <meta property="og:title" content="松葉屋茶寮">
  <meta property="og:description" content="松葉屋茶寮のお菓子やロールケーキのご予約・お取り置きはこちらから。店舗受け取りのご案内や注意事項もご確認いただけます。">
...
/*form input[type="submit"], form input[type="reset"], form input[type="button"] {
  ...
  <body id="contact" class="page-template-default page page-id-21 page-parent contact">
    <div id="wrapper">

      <header id="header">
          <div class="nav-box">
              <h1 class="logo pc logo-fade" id="header-logo-wrapper-pc">
                  <a href="../index.html"><img src="../assets/images/header-logo-black-pc.svg" alt="松葉屋茶寮"></a>
              </h1>
              <h1 class="logo sp logo-fade" id="header-logo-wrapper-sp">
                  <a href="../index.html"><img src="../assets/images/header-logo-black-sp.svg" alt="松葉屋茶寮"></a>
              </h1>
              <div class="menu-box">
                          ...
                          <div class="outer">
                              <div class="inner">
                                  ...
                                  <div class="menu-right">
                                      <ul class="menu">
                                          <li>
                                              <a href="https://www.tablecheck.com/ja/matsubayasaryo-hakobunegallery/reserve/landing" target="_blank">
          ...
          <div class="contact-wrapper"> 
            <div class="inner-wrapper">
              ...
              <div class="horizontal-title-wrapper">
                <h2 class="logo-OKASHIYA">
                    <img src="../assets/images/logo-OKASHIYA.svg" alt="OKASHIYA">
                </h2>
                <h2 class="jp">店舗受け取りを<br class="br-sp">ご希望のお客様</h2><span class="border"></span>
                <h3 class="en">STORE PICKUP</h3>
              </div>
...
<div align="center">
<h4>入力にエラーがあります。<br />
下記をご確認の上「戻る」ボタンにて修正をお願い致します。<br />
<br />
</h4>
<?php echo $errm; ?><br /><br />
    
<div class="submit-btn-wrapper">
    <input class="submit-btn" type="button" value=" 前画面に戻る " onclick="history.back()">
</div>  
    
</div>
<?php }else{ ?>
<h3 align="center">確認画面</h3><br />
                ...
                <div class="left-box jp">
                    ...
                    <div class="middle-wrapper1">
                        <ul class="menu second">
                            <li>
                                <a class="footer-menu" href="../news/news.php">News &amp; Topics</a>
                            </li>
                            <li>
                                <a class="footer-menu" href="https://www.tablecheck.com/ja/matsubayasaryo-hakobunegallery/reserve/landing" target="_blank">Reservation&nbsp;<i class="fa-solid fa-arrow-up-right-from-square fa-sm"></i></a>
                            </li>
                        </ul>
                    </div>
                    <div class="middle-wrapper1">
                ...
                <div class="right-box jp">
                    <h2 class="logo">
                        <a href="index.html" id="footer-logo">
                            <img src="../assets/images/footer-logo-black.svg" alt="松葉屋茶寮">
                        </a>
                    </h2>
...
<br /><br />
<div class="link-button submit"><input class="wpcf7-form-control wpcf7-submit has-spinner text" type="button" value=" 前画面に戻る " onclick="history.back()"></div>
</div>
</div>
            </div>
          </div>
        ...
        <footer id="footer">
            <div class="footer-wrapper">
                ...
                <div class="left-box jp">
                    ...
                    <div class="middle-wrapper1">
                        <ul class="menu second">
                            <li><a class="footer-menu" href="../news/news.php">News &amp; Topics</a></li>
                            <li><a class="footer-menu" href="https://www.tablecheck.com/ja/matsubayasaryo-hakobunegallery/reserve/landing" target="_blank">Reservation&nbsp;<i class="fa-solid fa-arrow-up-right-from-square fa-sm"></i></a></li>
                            <li><a class="footer-menu" href="https://hkbn.jp" target="_blank">hakobune Gallery EC Site</a></li>
                            <li><a class="footer-menu" href="https://www.okashiya.co.jp/" target="_blank">OKASHIYA EC Site</a></li>
                            <li><a class="footer-menu" href="../contact.html">Contact</a></li>
                            <li><a class="footer-menu" href="../access.html">Access</a></li>
                            <li><a class="footer-menu" href="https://arwrk.net/recruit/dfhwtyg4a36d23u" target="_blank">Recruit</a></li>
                            <li><a class="footer-menu" href="https://www.instagram.com/matsubayasaryo/" target="_blank">Instagram</a></li>
                        </ul>
                    </div>
                    <div class="bottom-wrapper2 bottom">
                        <span class="recruit"><a class="footer-menu" href="../privacy-policy.html">Privacy Policy</a></span>
                    </div>
                    <p class="copyright-sp" id="copyright"><small>&copy;Matsubaya sary&#x14D;</small></p>
                </div>
                <div class="right-box jp">
                    <h2 class="logo"><a href="../index.html" id="footer-logo"><img src="../assets/images/footer-logo.svg" alt="松葉屋茶寮"></a></h2>
                    <div class="bottom-wrapper">
                        <p id="copyright"><small>&copy;Matsubaya sary&#x14D;</small></p>
                    </div>
                </div>
...
function postToMail($arr){
	...
	foreach($arr as $key => $val){
		$out = '';
		if(is_array($val)){
			// チェックボックスの選択された値だけを処理する
			foreach($val as $key02 => $item){ 
				if(!empty($item)){  // 選択されていない項目は無視
					if(is_array($item)){
		...
		// 選択された項目のみを追加
		if($out != "confirm_submit" && $key != "httpReferer" && $key != "upfilePath" && $key != "upfileType" && $key != $ConfirmEmail && !empty($out)) {
...
function confirmOutput($arr){
	...
	foreach($arr as $key => $val) {
		...
		if (version_compare(PHP_VERSION, '5.1.0', '<=') && get_magic_quotes_gpc()) { // PHP5.1.0以下の場合のみ実行
